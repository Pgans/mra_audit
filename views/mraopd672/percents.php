...
$this->title = 'OPD-2567  ครั้งที่2';
$this->params['breadcrumbs'][] = ['label' => 'หน้าหลัก', 'url' => ['mraipd67/index']];
$this->params['breadcrumbs'][] = 'ประมวลผลความสมบูรณ์เวชระเบียนผู้ป่วยนอก2567';
?>
<style>
    .vibrant-bg {
...
<br>
<b><a>ประมวลผลความสมบูรณ์เวชระเบียนผู้ป่วยนอก2567</a></b>
<div class='well' style='background-color: lightblue;'>
    ...
    <?php
        ...
        <?php $form = ActiveForm::begin([ ]);
         echo Html::a('Pdf', [ 'mraopd672/percentpdf', 'id' => $model->id,], [ 'class' => 'btn btn-warning','target' => '_blank',]);   
