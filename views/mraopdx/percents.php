...
echo GridView::widget([
        ...
        <thead>
        <tr>
<th style="background-color:green; border: 1px solid white; border-radius: 50%; color: white; text-align: center;">Content medical record</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Profile</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Hist</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Phys</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Teat</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Foll1</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Foll2</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Foll3</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Oper</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Inf</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Sum</th>
<th style="background-color: green; border-radius: 50%; color: white; text-align: center;">Full</th>
