...
function handleNA2Chk() {    
    if(NA2.value=='N'||NA2.value=='n'){
          ...
          document.getElementById("other9").value = "";
          document.getElementById("other_huk").value = "0";
...
function handleMI01Chk() {         
 ...
 function handleMI09Chk() {   
    if(Missing9.value=='M'||Missing9.value=='m'){
        ...
        document.getElementById("Missing9").value = "-";
        document.getElementById("on1").value = "1";
        document.getElementById("on2").value = "1";
        document.getElementById("on3").value = "1";
        document.getElementById("on4").value = "1";
        ...
        document.getElementById("on7").value = "1";
        document.getElementById("on8").value = "1";
        document.getElementById("on9").value = "1";  on
        document.getElementById("NO9").readOnly = false;
        document.getElementById("on1").readOnly = false;
        document.getElementById("on2").readOnly = false;
        document.getElementById("on3").readOnly = false;
 ...
 function handleMI10Chk() {   
    if(Missing10.value=='M'||Missing10.value=='m'){
        document.getElementById("Missing10").value = "M";
        ...
        document.getElementById("Missing10").value = "-";
        document.getElementById("lr1").value = "1";
        document.getElementById("lr2").value = "1";
        document.getElementById("lr3").value = "1";
        document.getElementById("lr4").value = "1";
        ...
        document.getElementById("lr7").value = "1";
        document.getElementById("lr8").value = "1";
        document.getElementById("lr9").value = "1";  on
        document.getElementById("NO10").readOnly = false;
        document.getElementById("lr1").readOnly = false;
        document.getElementById("lr2").readOnly = false;
        document.getElementById("lr3").readOnly = false;
 ...
 function handleMI11Chk() {   
    if(Missing11.value=='M'||Missing11.value=='m'){
        document.getElementById("Missing11").value = "M";
        ...
        document.getElementById("Missing11").value = "-";
        document.getElementById("rr1").value = "1";
        document.getElementById("rr2").value = "1";
        document.getElementById("rr3").value = "1";
        document.getElementById("rr4").value = "1";
...
function handleSC1Chk() {     
        ...
        if(SC111.value=='N'||SC111.value=='n'||SC111.value=='1'||SC111.value=='0'){  }else{ document.getElementById("SC111").value = "0"; }
        if(SC112.value=='N'||SC112.value=='n'||SC112.value=='1'||SC112.value=='0'){  }else{ document.getElementById("SC112").value = "0"; }
...
<div class="mraipd-form">
    ...
    background: linear-gradient(to bottom, #E3E4FA, #B8F4B8); /* ไล่สีจากสีม่วงอ่อนถึงสีม่วงเข้ม */
    padding: 20px;
    border-radius: 10px;
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); /* ขอบ 3 มิติ */
...
">
      ...
      <div class="row">
          ...
          <div class="col-md-1">
          <?= $form->field($model, 'visits')->dropDownList(['1' => '1', '2' => '2', '3' => '3','4'=>'4'])?>
          </div>
         
		 <div class="col-md-2"> <?= $form->field($model, 'dr_license')
                ->dropDownList(['กาญจนา สายเบาะ' => 'กาญจนา สายเบาะ',
                                'พรมีนา กุลสะท้าน' => 'พรมีนา กุลสะท้าน',
                                'สายใจ บุญทา ' => 'สายใจ บุญทา',
								'จนท.ward1' => 'จนท.ward1',
								'จนท.ward2' => 'จนท.ward2',
...
<div class="table-responsive">
    ...
    <table>
    <tr>
        <th><a>Content of medical record</a></th><th style="color: green;">NA (N)</th><th style="color: green;">Miss (M)</th><th style="color: green;">No (O)</th>
		<th style="color: green;">ข้อที่1</th><th style="color: green;">ข้อที่2</th><th style="color: green;">ข้อที่3</th><th style="color: green;">ข้อที่4</th>
		<th style="color: green;">ข้อที่5</th><th style="color: green;">ข้อที่6</th><th style="color: green;">ข้อที่7</th><th style="color: green;">ข้อที่8</th>
		<th style="color: green;">ข้อที่9</th><th style="color: green;">หัก</th>
    </tr>
        <tr>
        <td><a>1.Discharge summary :Dx, Op</a></td>
            ...
            <td><?= $form->field($model, 'dxop1')->textInput(['id'=>"dxop1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'dxop2')->textInput(['id'=>"dxop2",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'dxop3')->textInput(['id'=>"dxop3",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'dxop4')->textInput(['id'=>"dxop4",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'dxop5')->textInput(['id'=>"dxop5",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'dxop6')->textInput(['id'=>"dxop6",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'dxop7')->textInput(['id'=>"dxop7",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'dxop8')->textInput(['id'=>"dxop8",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'dxop9')->textInput(['id'=>"dxop9",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'dxop_huk')->textInput(['id'=>"dxop_huk",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
        </tr>     
        </tr>
        <tr>
            <td style="col:#ffff; backgroup:black;"><a>2.Discharge summary : Dx, Other</a></td>
          <td><?= $form->field($model, 'NA2')->textInput(['id'=>'NA2','size'=>1,'maxlength' => 1, 'onchange'=>'handleNA2Chk(this)','value'=>'-'])->label(false) ?></td>
            ...
            <td><?= $form->field($model, 'other1')->textInput(['id'=>"other1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'other2')->textInput(['id'=>"other2",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'other3')->textInput(['id'=>"other3",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'other4')->textInput(['id'=>"other4",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'other5')->textInput(['id'=>"other5",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'other6')->textInput(['id'=>"other6",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'other7')->textInput(['id'=>"other7",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'other8')->textInput([
    'id' => 'other8',
    'size' => 1,
    'maxlength' => 1,
    'value' => '',
    'disabled' => true,
    'style' => 'background-color: #e0e0e0; color: #888;', // สีเทา
    'onchange' => 'handleSC1Chk(this)'
])->label(false) ?></td>

<td><?= $form->field($model, 'other9')->textInput([
    'id' => 'other9',
    'size' => 1,
    'maxlength' => 1,
    'value' => '',
    ...
    'onchange' => 'handleSC1Chk(this)'
						...
						<td><?= $form->field($model, 'other_huk')->textInput(['id'=>"other_huk",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
					</tr>
					<tr>
            ...
            <td><?= $form->field($model, 'infc1')->textInput(['id'=>"infc1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'infc2')->textInput(['id'=>"infc2",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'infc3')->textInput(['id'=>"infc3",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'infc4')->textInput(['id'=>"infc4",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'infc5')->textInput(['id'=>"infc5",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'infc6')->textInput(['id'=>"infc6",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'infc7')->textInput(['id'=>"infc7",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'infc8')->textInput(['id'=>"infc8",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'infc9')->textInput(['id'=>"infc9",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td> 
            <td><?= $form->field($model, 'infc_huk')->textInput(['id'=>"infc_huk",'size'=>1,'maxlength' => 1,'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
        </tr>
        <tr>
            <td><a>4.History</a></td>
            ...
            <td><?= $form->field($model, 'hist1')->textInput(['id'=>"hist1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'hist2')->textInput(['id'=>"hist2",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'hist3')->textInput(['id'=>"hist3",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'hist4')->textInput(['id'=>"hist4",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'hist5')->textInput(['id'=>"hist5",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'hist6')->textInput(['id'=>"hist6",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'hist7')->textInput(['id'=>"hist7",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'hist8')->textInput(['id'=>"hist8",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'hist9')->textInput(['id'=>"hist9",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'hist_huk')->textInput(['id'=>"hist_huk",'size'=>1,'maxlength' => 1,'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
        </tr>
        <tr>
            <td><a>5.Physical examination</a></td>
            ...
            <td><?= $form->field($model, 'pe1')->textInput(['id'=>"pe1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pe2')->textInput(['id'=>"pe2",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pe3')->textInput(['id'=>"pe3",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pe4')->textInput(['id'=>"pe4",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pe5')->textInput(['id'=>"pe5",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pe6')->textInput(['id'=>"pe6",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pe7')->textInput(['id'=>"pe7",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pe8')->textInput(['id'=>"pe8",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pe9')->textInput(['id'=>"pe9",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>     
            <td><?= $form->field($model, 'pe_huk')->textInput(['id'=>"pe_huk",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>   
        ...
        <tr>
            ...
            <td><?= $form->field($model, 'pn1')->textInput(['id'=>"pn1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pn2')->textInput(['id'=>"pn2",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pn3')->textInput(['id'=>"pn3",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pn4')->textInput(['id'=>"pn4",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pn5')->textInput(['id'=>"pn5",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pn6')->textInput(['id'=>"pn6",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pn7')->textInput(['id'=>"pn7",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pn8')->textInput(['id'=>"pn8",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'pn9')->textInput(['id'=>"pn9",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>     
            <td><?= $form->field($model, 'pn_huk')->textInput(['id'=>"pn_huk",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>   
        </tr>
        <tr>
            ...
            <td> <?= $form->field($model, 'cr1')->textInput(['id'=>"cr1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=> 'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'cr2')->textInput(['id'=>'cr2','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=> 'readonly',])->label(false) ?></td>
            <td> <?= $form->field($model, 'cr3')->textInput(['id'=>'cr3','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=> 'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'cr4')->textInput(['id'=>'cr4','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=> 'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'cr5')->textInput(['id'=>'cr5','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=> 'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'cr6')->textInput(['id'=>'cr6','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=> 'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'cr7')->textInput(['id'=>'cr7','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=> 'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'cr8')->textInput(['id'=>'cr8','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=> 'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'cr9')->textInput(['id'=>'cr9','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=> 'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'cr_huk')->textInput(['size'=>1,'maxlength' => 1])->label(false) ?></td>
        </tr>
        <tr>
            ...
            <td> <?= $form->field($model, 'ar1')->textInput(['id'=>"ar1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'ar2')->textInput(['id'=>'ar2','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'ar3')->textInput(['id'=>'ar3','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'ar4')->textInput(['id'=>'ar4','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'ar5')->textInput(['id'=>'ar5','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'ar6')->textInput(['id'=>'ar6','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'ar7')->textInput(['id'=>'ar7','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'ar8')->textInput(['id'=>'ar8','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'ar9')->textInput(['id'=>'ar9','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'ar_huk')->textInput(['size'=>1,'maxlength' => 1])->label(false) ?></td>
        </tr>
        <tr>
           ...
           <td><?= $form->field($model, 'NA9')->textInput(['id'=>'NA9','size'=>1,'maxlength' => 1, 'onchange'=>'handleNA9Chk(this)','value'=>'N' ,'autocomplete'=> 'off'])->label(false) ?></td>
            <td><?= $form->field($model, 'Missing9')->textInput(['id'=>'Missing9','size'=>1,'maxlength' => 1,'value'=>'-', 'onchange'=> 'handleMI09Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'No9')->textInput(['size'=>1,'id'=>'NO9','size'=>1,'maxlength' => 1, 'onchange'=>'handleNO9Chk(this)','value'=>'-'])->label(false) ?></td>
            <td> <?= $form->field($model, 'on1')->textInput(['id'=>"on1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'on2')->textInput(['id'=>'on2','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'on3')->textInput(['id'=>'on3','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'on4')->textInput(['id'=>'on4','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'on5')->textInput(['id'=>'on5','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'on6')->textInput(['id'=>'on6','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'on7')->textInput(['id'=>'on7','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'on8')->textInput(['id'=>'on8','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td> <?= $form->field($model, 'on9')->textInput(['id'=>'on9','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'on_huk')->textInput(['size'=>1,'maxlength' => 1])->label(false) ?></td>
        </tr>
        <tr>
            ...
            <td><?= $form->field($model, 'Missing10')->textInput(['id'=>'Missing10','size'=>1,'maxlength' => 1,'value'=>'-', 'onchange'=> 'handleMI10Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'No10')->textInput(['size'=>1,'id'=>'NO10','size'=>1,'maxlength' => 1, 'onchange'=>'handleNO10Chk(this)','value'=>'-'])->label(false) ?></td>
            <td><?= $form->field($model, 'lr1')->textInput(['id'=>"lr1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'lr2')->textInput(['id'=>'lr2','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'lr3')->textInput(['id'=>'lr3','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'lr4')->textInput(['id'=>'lr4','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'lr5')->textInput(['id'=>'lr5','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'lr6')->textInput(['id'=>'lr6','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'lr7')->textInput(['id'=>'lr7','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'lr8')->textInput(['id'=>'lr8','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'lr9')->textInput(['id'=>'lr9','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'lr_huk')->textInput(['size'=>1,'maxlength' => 1])->label(false) ?></td>
        </tr>
        <tr>
           ...
           <td><?= $form->field($model, 'NA11')->textInput(['id'=>'NA11','size'=>1,'maxlength' => 1, 'onchange'=>'handleNA11Chk(this)','value'=>'N' ,'autocomplete'=> 'off'])->label(false) ?></td>
            <td><?= $form->field($model, 'Missing11')->textInput(['id'=>'Missing11','size'=>1,'maxlength' => 1,'value'=>'-', 'onchange'=> 'handleMI11Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'No11')->textInput(['size'=>1,'id'=>'NO11','size'=>1,'maxlength' => 1, 'onchange'=>'handleNO11Chk(this)','value'=>'-'])->label(false) ?></td>
            <td><?= $form->field($model, 'rr1')->textInput(['id'=>"rr1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'rr2')->textInput(['id'=>'rr2','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'rr3')->textInput(['id'=>'rr3','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'rr4')->textInput(['id'=>'rr4','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'rr5')->textInput(['id'=>'rr5','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'rr6')->textInput(['id'=>'rr6','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'rr7')->textInput(['id'=>'rr7','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'rr8')->textInput(['id'=>'rr8','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'rr9')->textInput(['id'=>'rr9','size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)','readonly'=>'readonly'])->label(false) ?></td>
            <td><?= $form->field($model, 'rr_huk')->textInput(['size'=>1,'maxlength' => 1])->label(false) ?></td>
        </tr>
        <tr>
            ...
            <td><?= $form->field($model, 'nn1')->textInput(['id'=>"nn1",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'nn2')->textInput(['id'=>"nn2",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'nn3')->textInput(['id'=>"nn3",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'nn4')->textInput(['id'=>"nn4",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'nn5')->textInput(['id'=>"nn5",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'nn6')->textInput(['id'=>"nn6",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'nn7')->textInput(['id'=>"nn7",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'nn8')->textInput(['id'=>"nn8",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'nn9')->textInput(['id'=>"nn9",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>     
            <td><?= $form->field($model, 'nn_huk')->textInput(['id'=>"nn_huk",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>  
        </tr>
</table>
 <div class="table-responsive">
                    <div class="well">
...
<div class="col-md-6" align="left">
    <?= $form->field($model, 'overall_id')->radioList([
        '4' => 'ไม่มี',
        '1' => 'Documentation inadequate for meaningful revie',
        '2' => 'No significant medical record issue identified',
        '3' => 'Certain issue in question specify'
