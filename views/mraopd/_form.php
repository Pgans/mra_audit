...
function handleSCChk() {     
        ...
        if(SC012.value=='N'||SC012.value=='n'||SC012.value=='1'||SC012.value=='0'){  }else{ document.getElementById("SC012").value = "1"; }
        if(SC013.value=='N'||SC013.value=='n'||SC013.value=='1'||SC013.value=='0'){  }else{ document.getElementById("SC013").value = "1"; }
        if(SC014.value=='N'||SC014.value=='n'||SC014.value=='1'||SC014.value=='0'){  }else{ document.getElementById("SC014").value = "1"; }
        if(SC015.value=='N'||SC015.value=='n'||SC015.value=='1'||SC015.value=='0'){  }else{ document.getElementById("SC015").value = "1"; }
        if(SC016.value=='N'||SC016.value=='n'||SC016.value=='1'||SC016.value=='0'){  }else{ document.getElementById("SC016").value = "1"; }
        if(SC017.value=='N'||SC017.value=='n'||SC017.value=='1'||SC017.value=='0'){  }else{ document.getElementById("SC017").value = "1"; }
        if(SC021.value=='N'||SC021.value=='n'||SC021.value=='1'||SC021.value=='0'){  }else{ document.getElementById("SC021").value = "1"; }
        if(SC022.value=='N'||SC022.value=='n'||SC022.value=='1'||SC022.value=='0'){  }else{ document.getElementById("SC022").value = "1"; }
        if(SC023.value=='N'||SC023.value=='n'||SC023.value=='1'||SC023.value=='0'){  }else{ document.getElementById("SC023").value = "1"; }
        if(SC024.value=='N'||SC024.value=='n'||SC024.value=='1'||SC024.value=='0'){  }else{ document.getElementById("SC024").value = "1"; }
        if(SC025.value=='N'||SC025.value=='n'||SC025.value=='1'||SC025.value=='0'){  }else{ document.getElementById("SC025").value = "1"; }
        if(SC026.value=='N'||SC026.value=='n'||SC026.value=='1'||SC026.value=='0'){  }else{ document.getElementById("SC026").value = "1"; }
        if(SC027.value=='N'||SC027.value=='n'||SC027.value=='1'||SC027.value=='0'){  }else{ document.getElementById("SC027").value = "1"; }
        if(SC031.value=='N'||SC031.value=='n'||SC031.value=='1'||SC031.value=='0'){  }else{ document.getElementById("SC031").value = "1"; }
        if(SC032.value=='N'||SC032.value=='n'||SC032.value=='1'||SC032.value=='0'){  }else{ document.getElementById("SC032").value = "1"; }
        if(SC033.value=='N'||SC033.value=='n'||SC033.value=='1'||SC033.value=='0'){  }else{ document.getElementById("SC033").value = "1"; }
        if(SC034.value=='N'||SC034.value=='n'||SC034.value=='1'||SC034.value=='0'){  }else{ document.getElementById("SC034").value = "1"; }
        if(SC035.value=='N'||SC035.value=='n'||SC035.value=='1'||SC035.value=='0'){  }else{ document.getElementById("SC035").value = "1"; }
        if(SC036.value=='N'||SC036.value=='n'||SC036.value=='1'||SC036.value=='0'){  }else{ document.getElementById("SC036").value = "1"; }
        if(SC037.value=='N'||SC037.value=='n'||SC037.value=='1'||SC037.value=='0'){  }else{ document.getElementById("SC037").value = "1"; }
        if(SC041.value=='N'||SC041.value=='n'||SC041.value=='1'||SC041.value=='0'){  }else{ document.getElementById("SC041").value = "1"; }
        if(SC042.value=='N'||SC042.value=='n'||SC042.value=='1'||SC042.value=='0'){  }else{ document.getElementById("SC042").value = "1"; }
        if(SC043.value=='N'||SC043.value=='n'||SC043.value=='1'||SC043.value=='0'){  }else{ document.getElementById("SC043").value = "1"; }
        if(SC044.value=='N'||SC044.value=='n'||SC044.value=='1'||SC044.value=='0'){  }else{ document.getElementById("SC044").value = "1"; }
        if(SC045.value=='N'||SC045.value=='n'||SC045.value=='1'||SC045.value=='0'){  }else{ document.getElementById("SC045").value = "1"; }
        if(SC046.value=='N'||SC046.value=='n'||SC046.value=='1'||SC046.value=='0'){  }else{ document.getElementById("SC046").value = "1"; }
        if(SC047.value=='N'||SC047.value=='n'||SC047.value=='1'||SC047.value=='0'){  }else{ document.getElementById("SC047").value = "1"; }
...
<div class="mraopd-form">
	...
	<div align="center" class='well' style='
    ...
    <div class="col-md-3">
    <?= $form->field($model, 'unit_id')->widget(\kartik\select2\Select2::class, [
        'data' => ArrayHelper::map(Mradepartmetnsopd::find()->all(), 'unit_id', function ($model) {
            // แสดงทั้ง unit_id และ unit_name เพื่อให้ค้นหาได้ทั้งสองอย่าง
            return $model->unit_id . ' - ' . $model->unit_name;
        }),
        'options' => [
...
<!--<div class="box box-success box-solid" id="grad8">-->
  ...
  <tr>
    ...
    <td><?= $form->field($model, 'NA01')->textInput(['id'=>'NA01','size'=>1,'maxlength' => 1, 'value'=>'N','onchange'=> 'handleNA01Chk(this)'])->label(false) ?></td>
    ...
    <td><?= $form->field($model, 'PEIM01')->textInput(['id'=>'NO18','size'=>1,'maxlength' => 1,'autocomplete'=>'off','style' => 'background-color: lightgreen;'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC01')->textInput(['id'=>"DEC18",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)','style' => 'background-color: lightyellow;'])->label(false) ?></td>     
 </tr>
 <tr>
  	<td><font>2</font></td>
	<td class="left"><font> History (1<sup>st</sup> visit) </font></td>
	<td><?= $form->field($model, 'NA02')->textInput(['id'=>'NA02','size'=>1,'maxlength' => 1, 'value'=>'N','onchange'=> 'handleNA02Chk(this)'])->label(false) ?></td>
    ...
    <td><?= $form->field($model, 'PEIM02')->textInput(['id'=>'PEIM02','size'=>1,'maxlength' => 1,'autocomplete'=>'off','style' => 'background-color: lightgreen;'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC02')->textInput(['id'=>"DEC28",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)','style' => 'background-color: lightyellow;'])->label(false) ?></td>  
 </tr>
 <tr>
  	<td><font>3</font></td>
	<td class="left"><font> Physical examination </font></td>
    <td><?= $form->field($model, 'NA03')->textInput(['id'=>'NA03','size'=>1,'maxlength' => 1, 'value'=>'N','onchange'=> 'handleNA03Chk(this)'])->label(false) ?></td>
    ...
    <td><?= $form->field($model, 'PEIM03')->textInput(['id'=>'PEIM03','size'=>1,'maxlength' => 1,'autocomplete'=>'off','style' => 'background-color: lightgreen;'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC03')->textInput(['id'=>"DEC03",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)','style' => 'background-color: lightyellow;'])->label(false) ?></td>     
 </tr>
 <tr>
  	<td><font>4</font></td>
	<td class="left"><font> Teatment/Investigation </font></td>
     <td><?= $form->field($model, 'NA04')->textInput(['id'=>'NA04','size'=>1,'maxlength' => 1, 'value'=>'N','onchange'=> 'handleNA04Chk(this)'])->label(false) ?></td>
    ...
    <td><?= $form->field($model, 'PEIM04')->textInput(['id'=>'PEIM04','size'=>1,'maxlength' => 1,'autocomplete'=>'off','style' => 'background-color: lightgreen;'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC04')->textInput(['id'=>"DEC04",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)','style' => 'background-color: lightyellow;'])->label(false) ?></td>     
 </tr>
 <tr>
  	<td><font>5</font></td>
    ...
    <td><?= $form->field($model, 'PEIM05')->textInput(['id'=>'PEIM05','size'=>1,'maxlength' => 1,'autocomplete'=>'off','style' => 'background-color: lightgreen;'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC05')->textInput(['id'=>"DEC05",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)','style' => 'background-color: lightyellow;'])->label(false) ?></td>     
 ...
 <tr>
    ...
    <td><?= $form->field($model, 'PEIM06')->textInput(['id'=>'PEIM06','size'=>1,'maxlength' => 1,'autocomplete'=>'off','style' => 'background-color: lightgreen;'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC06')->textInput(['id'=>"DEC06",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)','style' => 'background-color: lightyellow;'])->label(false) ?></td>      
 </tr>
 <tr>
 <td><font></font></td>
   ...
   <td><?= $form->field($model, 'NA07')->textInput(['id'=>'NA07','size'=>1,'maxlength' => 1, 'value'=>'N','onchange'=> 'handleNA07Chk(this)'])->label(false) ?></td>
    <td><?= $form->field($model, 'MI037')->textInput(['id'=>'MI07','size'=>1,'maxlength' => 1,'value'=>'-', 'onchange'=> 'handleMI07Chk(this)'])->label(false) ?></td>
    ...
    <td><?= $form->field($model, 'PEIM07')->textInput(['id'=>'PEIM07','size'=>1,'maxlength' => 1,'autocomplete'=>'off','style' => 'background-color: lightgreen;'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC07')->textInput(['id'=>"DEC07",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)','style' => 'background-color: lightyellow;'])->label(false) ?></td>      
 </tr>
 <tr>
 <td><font>6</font></td>
    ...
    <td><?= $form->field($model, 'PEIM08')->textInput(['id'=>'NO08','size'=>1,'maxlength' => 1,'autocomplete'=>'off','style' => 'background-color: lightgreen;'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC08')->textInput(['id'=>"DEC08",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)','style' => 'background-color: lightyellow;'])->label(false) ?></td> 
 </tr>
 <tr>
 <td><font>7</font></td>
    ...
    <td><?= $form->field($model, 'PEIM09')->textInput(['id'=>'NO09','size'=>1,'maxlength' => 1,'autocomplete'=>'off','style' => 'background-color: lightgreen;'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC09')->textInput(['id'=>"DEC09",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)','style' => 'background-color: lightyellow;'])->label(false) ?></td> 
 </tr>
  <tr>
 <td><font>8</font></td>
    ...
    <td><?= $form->field($model, 'PEIM10')->textInput(['id'=>'NO10','size'=>1,'maxlength' => 1,'autocomplete'=>'off','style' => 'background-color: lightgreen;'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC10')->textInput(['id'=>"DEC10",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)','style' => 'background-color: lightyellow;'])->label(false) ?></td> 
 </tr>     
</table>
	<div class="table-responsive">
...
<div align="center" class="form-group">
    <?= Html::submitButton(
        '<i class="glyphicon glyphicon-plus"></i> ' . ($model->isNewRecord ? 'บันทึก' : 'แก้ไข'), 
        [
            'class' => ($model->isNewRecord ? 'btn btn-success' : 'btn btn-primary') . ' btn-lg',
            'id' => 'floating-submit-button',
            'style' => 'position: fixed; bottom: 20px; right: 20px; z-index: 9999; width: 120px;'
        ]) 
    ?>
</div>
...
$script = <<< JS
    $(document).ready(function() {
        $('#your-form-id').on('keypress', function(e) {
            if (e.which == 13) {
                e.preventDefault();
            }
        });
