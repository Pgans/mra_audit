            ...
            'columns' => [
                   // ['class' => 'yii\grid\SerialColumn'],
                    ...
                    'value' => function($model) {
                        ...
                        $amount = $model['amount'];
                        return Html::a(Html::encode($amount), ['repmonth/repmonth_list','rep' => $rep,
						'subfund' => $subfund],['target'=>'_blank']);
                    },
                    //'pageSummary'=> true,
                    ],
                    ]
             ...
             <input class="btn btn-primary" name="btnButton" type="button" value="Print Results" onClick="JavaScript:window.print();">
              <!-- <?php echo Html::a('ส่งการเงิน', ['repmonth/rep2'], ['class' => 'btn btn-success', 'style' => 'margin-left:5px','target'=>'_blank']); ?>
