    ...
    <tr>
        ...
        <tr>
           ...
           <td><?= $form->field($model, 'NA2')->textInput(['id'=>'NA2','size'=>1,'maxlength' => 1, 'onchange'=>'handleNA2Chk(this)','value'=>'-'])->label(false) ?></td>
            ...
            <td><?= $form->field($model, 'other8')->textInput(['id'=>"other8",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
            <td><?= $form->field($model, 'other9')->textInput(['id'=>"other9",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSC1Chk(this)'])->label(false) ?></td>
