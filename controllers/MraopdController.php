 ...
 public function actionIndex()
{
    ...
    $focusId = Yii::$app->request->get('focus_id');

    if ($focusId) {
        // จัดเรียงให้ mra_id ที่ระบุอยู่บนสุด
        $dataProvider->query->orderBy([
            new \yii\db\Expression("FIELD(mra_id, {$focusId}) DESC"),
            'mra_id' => SORT_DESC
        ]);
    } else {
    ...
    return $this->render('index', [
        ...
        'focusId' => $focusId, // อย่าลืมส่งไปที่ view ด้วย
    ]);
}
    ...
    public function actionPercent() {
		...
		*/
       $sql = "SELECT
       s.hospcode, s.hosp_name,s.unit_id, '2/2567' as No,
